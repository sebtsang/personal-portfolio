...
export function Sticker({
  ...
  useEffect(() => {
    ...
    const onMove = (e: PointerEvent) => {
      ...
      // position inside the VISIBLE area — we need CONTENT coords for
      // the CSS left/top write. Add scrollLeft/scrollTop. Without this,
      // a sticker picked up while the page is scrolled jumps up by
      // `scrollTop` pixels.
